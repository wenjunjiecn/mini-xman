...
public class BankselectorComponent extends SelectorDeployment {
    ...
    public Response run(Request request) {
        ...
        if("1".equals(request.getParameterByKey("bankid"))){request.addParameter("dest_port","16222");}
else if("2".equals(request.getParameterByKey("bankid"))){request.addParameter("dest_port","16333");}
else if("3".equals(request.getParameterByKey("bankid"))){request.addParameter("dest_port","16444");}
